...
import { RecoveryWorkflowService } from '@mxf-dev/core/services/RecoveryWorkflowService';
import { AutoCorrectionIntegrationService } from '@mxf-dev/core/services/AutoCorrectionIntegrationService';
import { EnhancedParameterPattern, PatternRecommendation } from '@mxf-dev/core/types/PatternLearningTypes';
    ...
    handler: async (input: {
        ...
        try {
            ...
            if (testCorrection) {
                ...
                // Report the REAL outcome of the correction attempt — random
                // "success" polluted the auto-correction learning store.
                if (correctionResult.attemptId) {
                    await correctionService.reportCorrectionResult(
                        correctionResult.attemptId,
                        correctionResult.corrected,
                        correctionResult.corrected ? undefined : 'Correction attempt did not produce corrected parameters'
                    );
                }
            }
