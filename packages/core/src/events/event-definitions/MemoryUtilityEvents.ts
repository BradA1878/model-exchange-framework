...
import type { MemoryQValueUpdatedEventData, MemoryQValueBatchUpdatedEventData, MemoryRewardAttributedEventData } from '../../schemas/EventPayloadSchema.js';
import { OrparPhase, TaskOutcomeStatus } from '../../types/MemoryUtilityTypes.js';
 ...
 */
/**
 * Data carried by UTILITY_RETRIEVAL_COMPLETED (envelope data — the
 * BaseEventPayload wrapper carries eventType/agentId/channelId/timestamp).
 */
export interface UtilityRetrievalCompletedEventData {
    query: string;
    phase?: string;
    lambda: number;
    totalCandidates: number;
...
export interface MemoryUtilityPayloads {
    'memory:qvalue_updated': MemoryQValueUpdatedEventData;
    'memory:qvalue_batch_updated': MemoryQValueBatchUpdatedEventData;
    'memory:utility_retrieval_completed': UtilityRetrievalCompletedEventData;
    'memory:reward_attributed': MemoryRewardAttributedEventData;
