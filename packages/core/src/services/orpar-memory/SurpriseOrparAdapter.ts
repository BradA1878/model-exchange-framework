...
} from '../../types/OrparMemoryIntegrationTypes.js';
import { OrparMemoryEvents } from '../../events/event-definitions/OrparMemoryEvents.js';
import {
    KnowledgeGraphEvents,
    HighSurpriseRelationshipEventData,
} from '../../events/event-definitions/KnowledgeGraphEvents.js';
import { isKnowledgeGraphEnabled, isSurpriseDetectionEnabled } from '../../config/knowledge-graph.config.js';
import {
...
import { OrparPhase } from '../../types/MemoryUtilityTypes.js';
...
export class SurpriseOrparAdapter {
    ...
    private handleGraphSurpriseEvent(payload: {
        ...
        EventBus.server.emit(OrparMemoryEvents.SURPRISE_DETECTED, createBaseEventPayload(OrparMemoryEvents.SURPRISE_DETECTED, agentId || 'system', channelId || data.channelId, {
        ...
        if (data.surpriseScore >= this.thresholds.high) {
            ...
            EventBus.server.emit(OrparMemoryEvents.ADDITIONAL_OBSERVATION_QUEUED, createBaseEventPayload(OrparMemoryEvents.ADDITIONAL_OBSERVATION_QUEUED, agentId || 'system', channelId || data.channelId, {
                agentId: agentId || 'system',
                channelId: channelId || data.channelId,
                cycleId: `graph-surprise-${Date.now()}`,
    ...
    private createReObserveDecision(
        ...
        EventBus.server.emit(OrparMemoryEvents.ADDITIONAL_OBSERVATION_QUEUED, createBaseEventPayload(OrparMemoryEvents.ADDITIONAL_OBSERVATION_QUEUED, context.agentId, context.channelId, {
    ...
    private createInjectContextDecision(
        ...
        EventBus.server.emit(OrparMemoryEvents.SURPRISE_CONTEXT_INJECTED, createBaseEventPayload(OrparMemoryEvents.SURPRISE_CONTEXT_INJECTED, context.agentId, context.channelId, {
            agentId: context.agentId,
            channelId: context.channelId,
            cycleId: context.cycleId,
            surpriseScore: surprise.surpriseScore,
    ...
    private createPlanReconsiderationDecision(
        ...
        EventBus.server.emit(OrparMemoryEvents.PLAN_RECONSIDERATION_TRIGGERED, createBaseEventPayload(OrparMemoryEvents.PLAN_RECONSIDERATION_TRIGGERED, context.agentId, context.channelId, {
            agentId: context.agentId,
            channelId: context.channelId,
            cycleId: context.cycleId,
    ...
    private emitSurpriseDetectedEvent(
        ...
        EventBus.server.emit(OrparMemoryEvents.SURPRISE_DETECTED, createBaseEventPayload(OrparMemoryEvents.SURPRISE_DETECTED, context.agentId, context.channelId, {
            agentId: context.agentId,
            channelId: context.channelId,
            cycleId: context.cycleId,
            surpriseScore: surprise.surpriseScore,
    ...
    private emitDecisionMadeEvent(
        ...
        EventBus.server.emit(OrparMemoryEvents.SURPRISE_DECISION_MADE, createBaseEventPayload(OrparMemoryEvents.SURPRISE_DECISION_MADE, context.agentId, context.channelId, {
            agentId: context.agentId,
            channelId: context.channelId,
            cycleId: context.cycleId,
            decision
