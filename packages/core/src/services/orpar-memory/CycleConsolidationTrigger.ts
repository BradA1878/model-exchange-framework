...
export class CycleConsolidationTrigger {
    ...
    private async executeConsolidation(
        ...
        // Emit trigger event
        EventBus.server.emit(OrparMemoryEvents.CONSOLIDATION_TRIGGERED, createBaseEventPayload(OrparMemoryEvents.CONSOLIDATION_TRIGGERED, agentId, channelId, {
            agentId,
            channelId,
    ...
    private async executePromote(
        ...
        try {
            ...
            EventBus.server.emit(OrparMemoryEvents.MEMORY_PROMOTED, createBaseEventPayload(OrparMemoryEvents.MEMORY_PROMOTED, agentId, channelId, {
                agentId,
                channelId,
                memoryId,
                fromStratum,
    ...
    private async executeDemote(
        ...
        try {
            ...
            EventBus.server.emit(OrparMemoryEvents.MEMORY_DEMOTED, createBaseEventPayload(OrparMemoryEvents.MEMORY_DEMOTED, agentId, channelId, {
                agentId,
                channelId,
                memoryId,
                fromStratum,
    ...
    private async executeArchive(
        ...
        try {
            ...
            EventBus.server.emit(OrparMemoryEvents.MEMORY_ARCHIVED, createBaseEventPayload(OrparMemoryEvents.MEMORY_ARCHIVED, agentId, channelId, {
                agentId,
                channelId,
                memoryId,
    ...
    private async executeAbstract(
        ...
        try {
            ...
            EventBus.server.emit(OrparMemoryEvents.MEMORY_ABSTRACTED, createBaseEventPayload(OrparMemoryEvents.MEMORY_ABSTRACTED, agentId, channelId, {
                agentId,
                channelId,
                memoryId,
