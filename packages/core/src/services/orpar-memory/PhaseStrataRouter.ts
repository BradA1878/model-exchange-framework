...
import { MemoryStratum, MemoryEntry, MemoryQuery, MemoryRetrievalResult } from '../../types/MemoryStrataTypes.js';
...
export class PhaseStrataRouter {
    ...
    private emitRetrievalEvent(
        ...
        EventBus.server.emit(OrparMemoryEvents.PHASE_MEMORY_RETRIEVED, createBaseEventPayload(OrparMemoryEvents.PHASE_MEMORY_RETRIEVED, options.agentId ?? 'unknown', options.channelId ?? 'unknown', {
