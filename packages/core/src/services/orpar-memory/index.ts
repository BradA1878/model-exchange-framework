...
// Main coordinator
export { OrparMemoryCoordinator } from './OrparMemoryCoordinator.js';

// Component services
export { PhaseStrataRouter } from './PhaseStrataRouter.js';
export { SurpriseOrparAdapter } from './SurpriseOrparAdapter.js';
export { PhaseWeightedRewarder } from './PhaseWeightedRewarder.js';
export { CycleConsolidationTrigger } from './CycleConsolidationTrigger.js';
export { PhaseMemoryOperations } from './PhaseMemoryOperations.js';
export type { PhaseStorageResult } from './PhaseMemoryOperations.js';
