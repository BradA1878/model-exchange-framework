...
export class PhaseWeightedRewarder {
    ...
    public async applyRewards(
        ...
        try {
            EventBus.server.emit(OrparMemoryEvents.PHASE_REWARDS_BATCH_APPLIED, createBaseEventPayload(OrparMemoryEvents.PHASE_REWARDS_BATCH_APPLIED, context.agentId, context.channelId, {
    ...
    public async processOutcome(
        ...
        EventBus.server.emit(OrparMemoryEvents.PHASE_REWARD_ATTRIBUTED, createBaseEventPayload(OrparMemoryEvents.PHASE_REWARD_ATTRIBUTED, cycleMemoryUsage.agentId, cycleMemoryUsage.channelId, {
            agentId: cycleMemoryUsage.agentId,
            channelId: cycleMemoryUsage.channelId,
            cycleId: cycleMemoryUsage.cycleId,
            taskId: cycleMemoryUsage.taskId,
    ...
    private emitRewardCalculatedEvent(
        ...
        EventBus.server.emit(OrparMemoryEvents.PHASE_REWARD_CALCULATED, createBaseEventPayload(OrparMemoryEvents.PHASE_REWARD_CALCULATED, cycleMemoryUsage.agentId, cycleMemoryUsage.channelId, {
            agentId: cycleMemoryUsage.agentId,
            channelId: cycleMemoryUsage.channelId,
