...
export abstract class BaseMcpClient implements IMcpClient {
     ...
     */
    public listResources(_options?: McpResourceOptions): Observable<McpResourceContent[]> {
        // Mirrors getResource: an empty array would make "not implemented"
        // indistinguishable from "provider has no resources".
        return throwError(() => new Error('Resource listing not implemented for this provider'));
    }
