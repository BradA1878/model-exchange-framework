...
import { McpToolDefinition } from './McpServerTypes.js';

// ajv-formats ships CJS (`module.exports = plugin` with a `.default` mirror),
// so the import's shape differs between the NodeNext build and ts-jest's
// node10 resolver. Both branches below are the identical plugin function.
