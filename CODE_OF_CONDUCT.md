...
We as members, contributors, and leaders pledge to make participation in the Model Exchange Framework (MXF) community a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, caste, color, religion, or sexual identity and orientation.
...
* Being patient with newcomers and helping them learn the framework
* Sharing knowledge and expertise to help others succeed
* Providing clear, actionable feedback in issue discussions and pull requests
* Respecting the time and effort contributors put into the project
...
* Deliberately misusing or overloading framework resources for malicious purposes
* Posting spam or off-topic content in issues, pull requests, or discussions
...
* Private communication related to project activities
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the project maintainer responsible for enforcement at **BradA1878@pm.me**.
...
In addition to the general standards above, the MXF community follows these technical collaboration guidelines:

### Issue Reporting
* Search existing issues before creating new ones to avoid duplicates
* Provide complete environment details, steps to reproduce, and relevant logs
* Be respectful when requesting features or reporting bugs
* Redact sensitive information (API keys, tokens, credentials) from shared code and logs
...
* Respect the project maintainer's final decisions on contributions
...
**Thank you for helping make the Model Exchange Framework a welcoming and productive community for everyone.**
